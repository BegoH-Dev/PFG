          ...
          <div className="row">
            ...
            <div className="col-lg-2 col-md-6 mb-4">
              ...
              <ul className="list-unstyled">
                ...
                <li><Link to="#" className="footer-link">Menú</Link></li>
                <li><Link to="#" className="footer-link">Reservas</Link></li>
                <li><Link to="#" className="footer-link">Pedidos</Link></li>
              </ul>
            </div>
            ...
            <div className="col-lg-3 col-md-6 mb-4">
              ...
              <ul className="list-unstyled">
                <li><Link to="#" className="footer-link">Reparto</Link></li>
                <li><Link to="#" className="footer-link">Catering</Link></li>
                <li><Link to="#" className="footer-link">Eventos</Link></li>
              </ul>
            </div>
